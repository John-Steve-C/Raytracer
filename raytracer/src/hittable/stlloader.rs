...
use super::{objects::triangle::Triangle, Hittable, HittableList};
...
impl STL {
        ...
        T: Material + 'static + Copy,
    {
        ...
        for &obj in mesh.triangles() {
            let x = Vec3::new(
                obj.vertices()[0][0] as f64,
                obj.vertices()[0][1] as f64,
                obj.vertices()[0][2] as f64,
            );
            let y = Vec3::new(
                obj.vertices()[1][0] as f64,
                obj.vertices()[1][1] as f64,
                obj.vertices()[1][2] as f64,
            );
            let z = Vec3::new(
                obj.vertices()[2][0] as f64,
                obj.vertices()[2][1] as f64,
                obj.vertices()[2][2] as f64,
            );
